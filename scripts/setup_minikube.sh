...
# Idempotently install and start Minikube on a Linux VM using Docker driver by default.
# Requires sudo privileges for package installation and Docker group membership for the user.
...
start_minikube() {
  ...
  # Try to start or ensure running
